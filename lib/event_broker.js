  ...
  this.clients.forEach(function(client) {
    ...
    client.query.forEach(function(query) {
      ...
      if (topic.match(query.topic)) {
        ...
        if (client.streamEnabled) {
          copiedData.type = 'event';
          copiedData.topic = peerName + '/' + data.topic;
          copiedData.subscriptionId = query.subscriptionId;
        }
        ...
        client.send(topic, copiedData, function(err){
          if (err) {
