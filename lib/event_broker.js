...
EventBroker.prototype._publishNonStreamEnabledClient = (client, query, topic, data, sourceTopic, fromRemote) => {
...
EventBroker.prototype._publishStreamEnabledClient = (client, query, topic, data, sourceTopic, fromRemote) => {
