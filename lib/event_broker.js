...
//      console.log('Match:', topic, query.topic, topic.match(query.topic), peerName, query.name)
      if (topic.match(query.topic) && (!topic._useComponents || query.name === '*' || peerName === query.name) ) {
          if (client.streamEnabled) {
            msg.type = 'event';
