...
var Registry = module.exports = function(opts){
  ...
  if (opts.db) {
    ...
    this.location = path.join(process.cwd(), opts.path);
...
Registry.prototype._init = function(cb) {
  ...
  if(this.compactor) {
    this.compactor.open(this.location, function(err) {
      self.compactor.compact(function(err) {
        self.compactor.close(function(err) {
